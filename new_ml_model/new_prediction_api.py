...
FastAPI + MQTT service for the current "New folder" model set.

This folder's newest artifacts are a residual/uncertainty layer:
  - xgb_residual_model.joblib
  - uncertainty_model.joblib
  - optimal_z.joblib

Those models are not standalone predictors. They sit on top of TE-GRU and
LightGBM base predictions, using the meta-features:
  [tegru_prediction, lgbm_prediction, bayesian_blend_prediction]
"""
